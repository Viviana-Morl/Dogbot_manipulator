...
Eigen::VectorXd QUADRUPED::qpproblem( Eigen::Matrix<double,6,1> &Wcom_des)
{
   ...
   // std::cout<<"duratafriction"<<duration<<std::endl;
   ...
   for ( int i = 0; i < eigenQ.rows(); i++ ){
	...
	//Q.setcontent(30,30,&eigenQ(0,0));

// std::cout<<"quadratic term"<<eigenQ<<std::endl;
   ...
   for ( int i = 0; i < eigenc.rows(); i++ ){
	...
	//c.setcontent(30,&eigenc(0,0));


//std::cout<<"linear term"<<eigenc<<std::endl;
   ...
   // std::cout<<"A"<<eigenA<<std::endl;
	...
	grav<<0,0,9.8,0,0,0;
	eigenb.block(0,0,6,1)=-toEigen(BiasCOM).block(0,0,6,1);//-robot_mass*grav.transpose();

	eigenb.block(6,0,12,1)=-toEigen(JdqdCOM_lin);

	//std::cout<<"b"<<eigenb<<std::endl;
	...
	//std::cout<<"D"<<eigenD<<std::endl;
    //std::cout<<"D"<<Dfr<<//std::endl;
...
//std::cout<<"c"<<eigenC<<std::endl;
    ...
    //std::cout << "tilde Fb: " << x_eigen.block(0,0,30,1).transpose() << //std::endl;
    Eigen::Matrix<double,6,1> F = -(T_s*x_eigen - Wcom_des);
    //std::cout << "Fb star: " << Wcom_des << std::endl;
   // std::cout << "Fb: " << F << std::endl;
  
    Eigen::Matrix<double,12,1> Fc = x_eigen.block(18,0,12,1);
    //std::cout << "Fc:" << std::endl;
    //std::cout << Fc.transpose() << std::endl;
    
	Eigen::VectorXd tau= Eigen::VectorXd::Zero(12);
   // std::cout << "fc"<<x_eigen<< std::endl;
	//std::cout << "bias"<<eigenBiascom<< std::endl;
